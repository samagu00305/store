...
g_StartInternationalDeliveryMessage()
{
...
g_ErrorType_Fail_No_Image()
{
	return 1
}
g_ErrorType_Fail_No_Find()
{
	return 2
}
...
g_FindPosionType_upR()
{
	return "upR"
}
g_FindPosionType_downR()
{
	return "downR"
}
g_FindPosionType_upL()
{
	return "upL"
}
g_FindPosionType_downL()
{
	return "downL"
}
